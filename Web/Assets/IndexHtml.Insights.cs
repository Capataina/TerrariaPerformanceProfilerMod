...
internal static partial class DashboardAssets
{
    ...
    <!-- Mount points only; every surface is built from the shared readable
         ...
         lines, rheat heatmap) in Js.Insights.cs. KPI ring strip, dormant
         table (I2), observatory list + tabular detail (I1+I3+I4),
         cross-cutting section list (I5), engagement-vs-cost table (I6),
         mod-pair correlation table + heatmap (I7). -->
