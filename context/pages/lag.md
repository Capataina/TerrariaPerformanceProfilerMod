...
- **Open findings:** P1×1 · P2×6 · P3×4

## Open findings
### [P1] Duplicate VS BASE column · `id:3e5d3f`
...
### [P2] Density bars are always full-width · `id:3feb6c`
- **Category:** chart-fit
- **Where:** PER-SEGMENT LAG DENSITY / default state
...
### [P2] Titled as a cause×context matrix, renders as a flat bar list · `id:4e0cc3`
- **Category:** chart-fit
...
### [P2] Two unaligned row systems read as one confused table · `id:bd8222`
- **Category:** hierarchy
...
### [P2] Right-side table fills only the top third, large dead space below · `id:0a4677`
...
### [P2] Raw cluster id shown to the player · `id:3814e2`
...
### [P2] Histogram micro-bars and interval labels too small to read · `id:d85ae4`
- **Category:** readability
- **Where:** LAG RHYTHM / default state
...
### [P3] CONTEXT column is all dashes · `id:9e3804`
- **Category:** affordance
...
### [P3] Three rows in a panel sized for many · `id:7a2ecd`
- **Category:** layout-alignment
- **Where:** CAUSE × CONTEXT / default state
...
### [P3] Bar caption not centred on its bar · `id:7f3328`
- **Category:** layout-alignment
- **Where:** PER-SEGMENT LAG DENSITY / default state
...
### [P3] Peak label crowds the chart's top-right edge · `id:a7225d`
- **Category:** layout-alignment
