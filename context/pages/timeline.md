...
- **Open findings:** P1×3 · P2×4 · P3×3

## Open findings
### [P1] Swimlane fills are rainbow decoration, not encoding · `id:9610e1`
...
### [P1] Transition track text clipped and overlapping · `id:08d141`
...
### [P1] Swimlane block labels illegible on gradient fill · `id:1c63d4`
...
### [P2] Empty Boss/Invasion/Subworld lanes have no empty-state copy · `id:8e9910`
- **Category:** affordance
- **Where:** page / whole state
...
### [P2] Solid grey share bar encodes nothing · `id:556500`
- **Category:** colour-encoding
...
### [P2] All-zero readout under a populated-looking header · `id:c70f5a`
- **Category:** hierarchy
- **Where:** ATTENDANCE / default state
...
### [P2] Per-minute strip strands 85% dead space · `id:29cbac`
- **Category:** layout-alignment
- **Where:** page / whole state
...
### [P3] Long event log lacks filter by type · `id:38f03a`
- **Category:** affordance
...
### [P3] Two-line event rows waste vertical rhythm · `id:308baf`
- **Category:** chart-fit
- **Where:** CHRONICLE / default state
...
### [P3] Green 'transition' badge collides with perf-ramp green · `id:67f610`
- **Category:** colour-encoding
- **Where:** CHRONICLE / default state
