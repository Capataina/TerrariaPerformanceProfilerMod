...
## Page at a glance
- **Panes discovered (last run):** panel 1, dormant content, per-mod observatory, mod detail, cross-cutting signals, engagement vs cost, mod-pair cost correlation
- **Scenario audited:** `full`
- **Open findings:** P1×1 · P2×5 · P3×4

## Open findings
### [P1] Top panel clipped to an unusable sliver · `id:4364ab`
...
### [P2] Selection feedback is barely perceptible · `id:86fff1`
- **Category:** affordance
...
### [P2] Relationship data shown as a table, not a scatter · `id:61328c`
- **Category:** chart-fit
...
### [P2] Share-of-class bars are solid white and all max-length · `id:9dafb3`
...
### [P2] Three different gauge treatments in one KPI strip · `id:bce212`
...
### [P2] KPI strip has no panel title · `id:dbe41f`
- **Category:** consistency
- **Where:** page / default state
...
### [P3] Pink DORMANT marker is a lone categorical hue · `id:6c61bb`
- **Category:** colour-encoding
- **Where:** page / default state
...
### [P3] Headline ms value sits visually quieter than the rank number · `id:bee176`
- **Category:** hierarchy
...
### [P3] Zero-engagement bars are near-invisible · `id:3b667b`
...
### [P3] Magnitude bars indistinguishable across the top rows · `id:c198b1`
- **Category:** readability
